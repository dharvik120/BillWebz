...
function ProformaInvoiceForm() {
  ...
  const handleShareWhatsApp = () => {
    const text = `Hi, please find attached the Proforma Invoice / Quotation from ${invoiceData.sellerDetails.name}. Total amount estimated is ${invoiceData.currency.symbol}${invoiceData.totals.grandTotal}.`;
        ...
        <div className="space-y-6 flex flex-col justify-start no-print">
          <div className="border border-border/70 rounded-2xl overflow-hidden bg-card shadow-sm">
            ...
            <div>
              ...
              >
                <span className="flex items-center gap-2">
                  <Building className="h-4.5 w-4.5 text-indigo-600" /> Seller Business Details
                </span>
                ...
                <div className="p-5 border-b border-border/40 grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-border/80 rounded-lg bg-background focus:outline-none"
                    />
                  </div>
            ...
            <div>
              ...
              {activeAccordion === 'buyer' && (
                <div className="p-5 border-b border-border/40 grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                  ...
                  <div>
                    <label className="block text-slate-500 font-semibold mb-1">Place of Supply</label>
                    <input
                      type="text"
                      list="states-list"
                      placeholder="e.g. Delhi"
            ...
            <div>
              ...
              >
                <span className="flex items-center gap-2">
                  <Calendar className="h-4.5 w-4.5 text-indigo-600" /> Quotation Validities & Dates
                </span>
                ...
                <div className="p-5 border-b border-border/40 grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-border/80 rounded-lg bg-background font-mono font-bold"
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-slate-500 font-semibold mb-1">Quotation Valid Until Date</label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label className="block text-slate-500 font-semibold mb-1">Expected Delivery Date</label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label className="block text-slate-500 font-semibold mb-1">Delivery Note</label>
                    <input
                      type="text"
                      value={invoiceData.metadata.deliveryNote || ''}
                      onChange={(e) => updateField('metadata', 'deliveryNote', e.target.value)}
                      className="w-full px-3 py-2 border border-border/80 rounded-lg bg-background"
                    />
                  </div>

                  <div>
                    <label className="block text-slate-500 font-semibold mb-1">Vehicle / Transport Mode</label>
                    <input
                      type="text"
                  ...
                  <div className="flex items-center gap-2 pt-4">
                    <button
                      type="button"
                      onClick={() => updateField('showTax' as any, '', !invoiceData.showTax)}
                    ...
                    <span className="font-semibold text-slate-600">Apply GST Calculations</span>
                  </div>
                </div>
              )}
            </div>
            ...
            {/* Section 5: Quotation Statements */}
            <div>
              <button
                type="button"
              ...
              >
                <span className="flex items-center gap-2">
                  <FileText className="h-4.5 w-4.5 text-indigo-600" /> Quotation Declarations & Signatures
                </span>
              ...
              {activeAccordion === 'additional' && (
                <div className="p-5 border-b border-border/40 grid grid-cols-1 gap-4 text-xs">
                  <div>
                    <label className="block text-slate-500 font-semibold mb-1">Quotation Notes</label>
                    <textarea
                  ...
                  <div>
                    <label className="block text-slate-500 font-semibold mb-1">Notes</label>
                    <textarea
                  ...
                  <div>
                    <label className="block text-slate-500 font-semibold mb-1">Declaration</label>
                    <textarea
                  ...
                  <div className="flex items-center gap-2 border-t border-slate-100 pt-4">
                    ...
                    <span className="font-semibold text-slate-600">Show Diagonal Watermark</span>
                  </div>
                </div>
              )}
            </div>
